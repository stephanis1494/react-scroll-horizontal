...
var ScrollHorizontal = function (_Component) {
  ...
  function ScrollHorizontal(props) {
    ...
    _this.componentDidUpdate = function (prevProps) {
      ...
      } else if (_this.props.scrollToValue !== null && prevProps.scrollToValue !== _this.props.scrollToValue) {
        // Emulate scroll to exact position by passing an absolute value
        _this.setState({
          animValues: _this.props.scrollToValue
        }, _this.calculate());
      } else {
        _this.calculate();
      }
    ...
    if (props.onReachStart) _this.onReachStart = lodash_throttle(props.onReachStart, 800, { trailing: false });
    if (props.onReachEnd) _this.onReachEnd = lodash_throttle(props.onReachEnd, 800, { trailing: false });
    return _this;
  }
  ...
  createClass(ScrollHorizontal, [{
    ...
    value: function shouldComponentUpdate(nextProps, nextState) {
      if (this.calculate.timer !== void 0 && this.props.children === nextProps.children && this.state.animValues === nextState.animValues && this.props.animValues === nextProps.animValues && this.props.scrollToValue === nextProps.scrollToValue) {
        return false;
      }
    ...
    value: function caniscroll() {
      ...
      var scroller = el && el.firstElementChild;
    ...
    value: function calculate() {
      ...
      this.calculate.timer = setTimeout(function () {
        ...
        var max = el && el.lastElementChild.scrollWidth;
        var win = el && el.offsetWidth;

        // Get the new animation values
        var curr = _this3.state.animValues;

        if (_this3.props.onScroll) {
          _this3.props.onScroll(curr);
        }
